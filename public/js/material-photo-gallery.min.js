                ...
                !(function(n, s) {
                    ...
                    return (
                        ...
                        (s.prototype._layout = function() {
                            ...
                            s.on('progress', function(t, e) {
                                e.img.setAttribute(
                                    ...
                                    i._thumbs.push(e.img);
                            }),
                                s.on('done', function(t) {
                                    new e().init({
                                        after: function() {
                                            i.init(), i._loadFullImgs();
                                        }
                                    });
                                }),
                        ...
                        (s.prototype._loadFullImgs = function() {
                            for (
                                var t, e, i = 0, n = this._thumbs.length;
                                n > i;
                                i++
                            )
                        ...
                        (s.prototype._resetFullImg = function() {
                            this._fullImgsTransforms = [];
                            for (
                                var t = 0, e = this._fullImgs.length;
                                e > t;
                                t++
                            ) {
                                ({
                                ...
                                t === this._thumbIndex && this._fullImgOpen
                                    ? (this._fullImgs[t].removeAttribute(
                                          'style'
                                      ),
                                      this._positionFullImgs.call(
                                          this,
                        ...
                        (s.prototype._handleThumbClick = function(t) {
                            this._thumb != t.target &&
                                ((this._thumb = t.target),
                                (this._thumbIndex = this._thumbs.indexOf(
                                    this._thumb
                                )),
                                (this._fullImg = this._fullImgs[
                                    this._thumbIndex
                                ])),
                                this._setupComplete &&
                                    this._fullImgsLoaded &&
                        ...
                        (s.prototype._changeImg = function(t) {
                            (this._thumbIndex = this._fullImgs.indexOf(
                                this._fullImg
                            )),
                                'next' === t
                                    ? (this._thumbIndex += 1)
                ...
                !(function(t, n) {
                    ...
                    return (
                        ...
                        (e.align = function(t) {
                            var e = t.clientWidth,
                                i = parseInt(
                                    t.getAttribute('data-max-height') || 120
                                ),
